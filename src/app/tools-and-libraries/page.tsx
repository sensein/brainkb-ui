    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-sky-50">
            ...
            <section className="py-16 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="bg-gradient-to-br from-sky-50 to-emerald-50 rounded-2xl p-8 md:p-12 border border-sky-100 shadow-lg">
                        ...
                        <p className="text-lg text-gray-700 leading-relaxed">
                            ...
                            knowledge extraction, structured representation, provenance tracking, and advanced analytics. While 
                            these tools are (or will be) integrated into the BrainKB platform to support the BrainKB objective, 
                            they are also designed for independent use, offering flexibility.
                        </p>
                    </div>
                </div>
            </section>
