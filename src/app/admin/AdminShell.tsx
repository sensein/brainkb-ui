...
function AdminSidebar() {
  ...
  return (
    ...
    >
      <div style={{ padding: "4px 10px 16px", borderBottom: "1px solid var(--bkb-border)", marginBottom: 12, display: "flex", alignItems: "center", gap: 10 }}>
        <Logo size={22} />
        <div>
...
export function AdminShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div style={{ display: "grid", gridTemplateColumns: "220px 1fr", minHeight: "100%", background: "var(--bkb-bg)" }}>
      <AdminSidebar />
      <main style={{ padding: "28px 36px" }}>{children}</main>
    </div>
  );
}
