                ...
                <div className="flex items-center justify-center rounded bg-gray-50 h-28 dark:bg-gray-800">
                    <div className="text-center">
                        ...
                        <p className="text-gray-400 dark:text-gray-500">
                            On this page, you'll find all the evidence extracted from the paper, along with their corresponding links to the assertions. Our team is actively working on this, and we anticipate releasing the first version by May 30, 2025. Please check back for updates!
<br/>
