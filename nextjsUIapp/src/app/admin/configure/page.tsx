            ...
            <div className="grid grid-cols-2 gap-6 p-4">
                ...
                <div className="items-center justify-center rounded bg-gray-50 dark:bg-gray-800">
                    ...
                    <form className="w-full">
                            ...
                            <div className="mb-5">
                                <label htmlFor="endpointtype"
                                       className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select your
                                    country</label>
                        ...
                        <form className="w-full">
                            ...
                            <div className="mb-5">
                                <label for="large-input"
                                    ...
                                    Sparql query</label>
                                <textarea type="text" id="large-input" rows="5"
